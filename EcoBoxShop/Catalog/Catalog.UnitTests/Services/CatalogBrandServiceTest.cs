...
public class CatalogBrandServiceTest
{
    ...
    public async Task UpdateAsync_Success()
    {
        ...
        _catalogBrandRepository.Setup(s => s.UpdateAsync(
            It.IsAny<CatalogBrandEntity>())).ReturnsAsync(catalogBrandSuccess);
        ...
        // act
        var result = await _catalogBrandService.Update(catalogBrandSuccess.Id, catalogBrandSuccess.Title);
    ...
    public async Task UpdateAsync_Failed()
    {
        ...
        var testBrand = "test";
        _catalogBrandRepository.Setup(s => s.UpdateAsync(
            It.IsAny<CatalogBrandEntity>())).Returns((Func<CatalogBrandDto>)null!);
