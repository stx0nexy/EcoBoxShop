...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "EcoBoxShop- Catalog HTTP API",
        Version = "v1",
        ...
        Flows = new OpenApiOAuthFlows()
        {
            Implicit = new OpenApiOAuthFlow()
            {
                ...
                Scopes = new Dictionary<string, string>()
                {
                    ...
                    { "catalog.catalogsubcategory", "catalog.catalogsubcategory" }
                }
            }
        }
    });
...
builder.Services.AddTransient<ICatalogCategoryRepository, CatalogCategoryRepository>();
builder.Services.AddTransient<ICatalogCategoryService, CatalogCategoryService>();
builder.Services.AddTransient<ICatalogSubCategoryRepository, CatalogSubCategoryRepository>();
builder.Services.AddTransient<ICatalogSubCategoryService, CatalogSubCategoryService>();
